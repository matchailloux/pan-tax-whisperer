-- Migration 1: Add FIRM mode tables and extend existing ones
...
-- Create organization_type enum if not exists
DO $$ BEGIN
  CREATE TYPE organization_type AS ENUM ('INDIVIDUAL', 'FIRM');
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;

-- Update businesses table to use enum
ALTER TABLE public.businesses 
ALTER COLUMN type TYPE organization_type USING type::organization_type;